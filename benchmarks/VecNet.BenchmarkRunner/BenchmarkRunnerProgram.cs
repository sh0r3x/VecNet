...
public static class BenchmarkRunnerProgram
{
    ...
    private static void WriteUsage(TextWriter writer)
    {
        ...
        writer.WriteLine("  external-fashion-mnist --cache-root VecNet.DatasetCache --query-count 100 --truth-depth 10 --download false --metric squared-euclidean|cosine");
        writer.WriteLine("  external-fashion-mnist-exact --cache-root VecNet.DatasetCache --output VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-exact.json --query-count 3 --top-k 10 --runs 3 --warmup-queries 3 --metric squared-euclidean|cosine");
        writer.WriteLine("  external-fashion-mnist-hnsw --cache-root VecNet.DatasetCache --output VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-hnsw.json --query-count 3 --top-k 10 --runs 3 --warmup-queries 3 --metric squared-euclidean|cosine --m 8 --ef-construction 64 --ef-search 100 --hnsw-seed 0x484E535700000039");
        writer.WriteLine("  external-fashion-mnist-hnsw-durable --cache-root VecNet.DatasetCache --output VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-hnsw-durable.json --snapshot-directory VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-hnsw-durable-snapshot --query-count 3 --top-k 10 --runs 1 --warmup-queries 0 --metric squared-euclidean|cosine --m 8 --ef-construction 64 --ef-search 100 --hnsw-seed 0x484E535700010901");
        writer.WriteLine("  external-fashion-mnist-hnsw-base-plus-exact-delta --cache-root VecNet.DatasetCache --output VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-hnsw-base-plus-exact-delta.json --query-count 50 --top-k 100 --base-vectors 58000 --insertions 1000 --deletes 1000 --delta-deletes 100 --duplicate-inserts 1 --unknown-deletes 1 --repeated-deletes 1 --runs 1 --warmup-queries 3 --metric squared-euclidean|cosine --seed 0x5EED2127 --m 16 --ef-construction 128 --ef-search 192 --hnsw-seed 0x484E535700012700");
        writer.WriteLine("  external-fashion-mnist-hnsw-base-plus-exact-delta-checkpoint --cache-root VecNet.DatasetCache --output VecNet.BenchmarkRunner.Artifacts/vec-138-smoke/fashion-mnist-external-hnsw-base-plus-exact-delta-checkpoint.json --checkpoint-directory VecNet.BenchmarkRunner.Artifacts/vec-138-smoke/checkpoint-output --query-count 50 --top-k 100 --base-vectors 58000 --insertions 1000 --deletes 1000 --delta-deletes 100 --duplicate-inserts 1 --unknown-deletes 1 --repeated-deletes 1 --runs 2 --warmup-queries 3 --metric squared-euclidean|cosine --seed 0x5EED2137 --m 16 --ef-construction 128 --ef-search 192 --hnsw-seed 0x484E535700013700");
        writer.WriteLine("  external-fashion-mnist-hnsw-allowlist-filtered --cache-root VecNet.DatasetCache --output VecNet.BenchmarkRunner.Artifacts/vec-151-smoke/fashion-mnist-external-hnsw-allowlist-filtered.json --opened-index-directory VecNet.BenchmarkRunner.Artifacts/vec-151-smoke/opened-output --checkpoint-directory VecNet.BenchmarkRunner.Artifacts/vec-151-smoke/checkpoint-output --query-count 50 --top-k 10 --base-vectors 58000 --insertions 1000 --deletes 1000 --delta-deletes 100 --duplicate-inserts 1 --unknown-deletes 1 --repeated-deletes 1 --filter fallback-boundary|broad --runs 1 --warmup-queries 3 --metric squared-euclidean|cosine --seed 0x5EED2151 --m 16 --ef-construction 128 --ef-search 192 --hnsw-seed 0x484E535700015100");
        writer.WriteLine("  external-fashion-mnist-hnsw-base-plus-exact-delta-checkpoint-memory-smoke --cache-root VecNet.DatasetCache --output VecNet.BenchmarkRunner.Artifacts/vec-142-memory-smoke/fashion-mnist-external-hnsw-base-plus-exact-delta-checkpoint-memory-smoke.json --checkpoint-directory VecNet.BenchmarkRunner.Artifacts/vec-142-memory-smoke/checkpoint-output --metric squared-euclidean|cosine --sample-interval-ms 10");
        writer.WriteLine("  external-fashion-mnist-hnsw-base-plus-exact-delta-checkpoint-matrix --preset smoke|standard --cache-root VecNet.DatasetCache --metric squared-euclidean|cosine --output-dir VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-hnsw-base-plus-exact-delta-checkpoint-matrix --manifest VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-hnsw-base-plus-exact-delta-checkpoint-matrix/fashion-mnist-external-hnsw-base-plus-exact-delta-checkpoint-matrix-manifest.json");
        writer.WriteLine("  external-fashion-mnist-hnsw-base-plus-exact-delta-matrix --preset smoke|standard --cache-root VecNet.DatasetCache --query-count 50 --runs 1 --warmup-queries 3 --metric squared-euclidean|cosine --seed 0x5EED2128 --duplicate-inserts 1 --unknown-deletes 1 --repeated-deletes 1 --output-dir VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-hnsw-base-plus-exact-delta-matrix --manifest VecNet.BenchmarkRunner.Artifacts/fashion-mnist-external-hnsw-base-plus-exact-delta-matrix/fashion-mnist-external-hnsw-base-plus-exact-delta-matrix-manifest.json");
    }
}
