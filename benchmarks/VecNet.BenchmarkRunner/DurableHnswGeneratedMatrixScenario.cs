...
public static class DurableHnswGeneratedMatrixScenario
{
    ...
    [
        ...
        new("low-ef-m4", VectorMetric.InnerProduct, Dimension: 16, VectorCount: 64, QueryCount: 3, TopK: 5, M: 4, EfConstruction: 16, EfSearch: 8, Runs: 1, WarmupQueries: 0),
        new("balanced-m8", VectorMetric.InnerProduct, Dimension: 32, VectorCount: 128, QueryCount: 4, TopK: 10, M: 8, EfConstruction: 32, EfSearch: 24, Runs: 1, WarmupQueries: 1),
        new("wide-m12", VectorMetric.InnerProduct, Dimension: 128, VectorCount: 192, QueryCount: 5, TopK: 25, M: 12, EfConstruction: 64, EfSearch: 64, Runs: 2, WarmupQueries: 1),
        new("tail-balanced-m8", VectorMetric.InnerProduct, Dimension: 386, VectorCount: 96, QueryCount: 3, TopK: 25, M: 8, EfConstruction: 64, EfSearch: 64, Runs: 1, WarmupQueries: 1),
        ...
        IReadOnlyList<string> commandArguments)
    {
        ...
        return new DurableHnswGeneratedMatrixManifest(
            ...
            [
                "Generated SquaredEuclidean, InnerProduct and Cosine durable-HNSW matrix smoke evidence only; no external datasets, public claims, preview readiness or baseline policy are introduced.",
