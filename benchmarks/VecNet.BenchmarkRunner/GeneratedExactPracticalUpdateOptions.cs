...
public sealed record GeneratedExactPracticalUpdateOptions(
    VectorMetric Metric,
    int Dimension,
    int BaseVectorCount,
    int QueryCount,
    ...
    int WarmupQueries = 0)
{
    public const string ScenarioName = "generated-exact-practical-update";
    ...
    public static string NormalizeSelectivityKind(string value)
    {
        ...
        throw new ArgumentException($"Unsupported generated exact practical-update selectivity kind '{value}'.");
    }
}
