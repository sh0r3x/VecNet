...
public sealed record GeneratedExactUpdateOptions(
    VectorMetric Metric,
    int Dimension,
    int BaseVectorCount,
    int QueryCount,
    ...
    int WarmupQueries = 0)
{
    public const string ScenarioName = "generated-exact-update";
    ...
    public static string NormalizeSelectivityKind(string value)
    {
        ...
        throw new ArgumentException($"Unsupported generated exact update selectivity kind '{value}'.");
    }
}
