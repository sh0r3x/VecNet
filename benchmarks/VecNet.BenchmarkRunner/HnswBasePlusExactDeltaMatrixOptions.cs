...
public sealed record HnswBasePlusExactDeltaMatrixOptions(
    string PresetName,
    int BaseVectorCount,
    int QueryCount,
    int Runs,
    ...
    string ManifestPath)
{
    public const string ScenarioName = "generated-hnsw-base-plus-exact-delta-matrix";
    ...
    public static string NormalizePresetName(string presetName)
    {
        ...
        throw new ArgumentException($"Unsupported HNSW base-plus-exact-delta matrix preset '{presetName}'.");
    }
}
